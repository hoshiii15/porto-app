...
const Footer = ({ profile }) => {
    ...
    return (
        <footer id="contact" className="relative bg-gradient-to-br from-gray-900 via-gray-900 to-black border-t border-gray-800/50 overflow-hidden">
                    ...
                    <div className="md:col-span-2">
                        <div className="flex items-center space-x-3 mb-6">
                            <div className="w-12 h-12 bg-gradient-to-br from-blue-600 to-purple-600 rounded-xl flex items-center justify-center">
                                <span className="text-white font-bold text-xl">{profile?.name ? profile.name.charAt(0).toUpperCase() : 'P'}</span>
                            </div>
